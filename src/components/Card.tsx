...
function CardComponent({
  ...
  return (
    <motion.div
      onClick={onClick}
      className={`w-full aspect-[3/4] relative select-none ${className}`}
      ...
      <AnimatePresence mode="wait" initial={false}>
        {isFaceUp ? (
          <motion.div
            ...
            className={`geometric-card w-full h-full flex flex-col items-start justify-between ${
          ...
          <motion.div
            ...
            exit={{ rotateY: 90, opacity: 0 }}
            transition={{ duration: 0.2 }}
            className="geometric-card geometric-card-back w-full h-full"
