      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {activeMatches.map((game, index) => (
          <motion.div 
            ...
            className="theme-panel p-4 border-2 border-ui-green bg-[#111111] flex flex-wrap items-center justify-between gap-4 h-full"
          >
            ...
            <div className="flex-1 min-w-[280px] w-full mt-2 xl:mt-0">
      ...
      <AnimatePresence>
        {statusMsg && (
          <motion.div 
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            className={`fixed top-[calc(env(safe-area-inset-top,0px)+5.5rem)] left-1/2 -translate-x-1/2 z-[999999] p-4 border-4 flex gap-4 justify-between items-center w-11/12 max-w-sm rounded-sm shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] ${statusMsg.type === 'success' ? 'bg-bg-dark border-ui-green text-ui-green' : 'bg-bg-dark border-ui-red text-ui-red'}`}
          >
